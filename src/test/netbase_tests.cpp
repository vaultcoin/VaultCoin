...
BOOST_AUTO_TEST_CASE(netbase_networks)
{
    ...
    BOOST_CHECK(CNetAddr("2001::22152").GetNetwork()                             == NET_IPV6);
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:22152", "127.0.0.1", 22152));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:22152", "127.0.0.1", 22152));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:22152", "::ffff:127.0.0.1", 22152));
    BOOST_CHECK(TestSplitHost("[::]:22152", "::", 22152));
    BOOST_CHECK(TestSplitHost("::22152", "::22152", -1));
    BOOST_CHECK(TestSplitHost(":22152", "", 22152));
    BOOST_CHECK(TestSplitHost("[]:22152", "", 22152));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:22152", "127.0.0.1:22152"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:22152", "[::]:22152"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
